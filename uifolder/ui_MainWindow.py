...
"}")
        ...
        self.frame_main.setStyleSheet(u"/* COMBOBOX */\n"
"QComboBox{\n"
...
"	background-color: rgb(85, 170, 255);\n"
"}")
        self.btn_toggle_menu.setIconSize(QSize(48, 48))
        ...
        brush15 = QBrush(QColor(33, 37, 43, 255))
...
#endif
        self.frame_top_btns.setPalette(palette1)
        self.frame_top_btns.setStyleSheet(u"QFrame{\n"
"background-color: rgb(33, 37, 43);\n"
"}")
        ...
        self.label_title_bar_top.setMinimumSize(QSize(600, 0))
        font1 = QFont()
...
"")
        ...
        self.combobox_connectionstring.setMinimumSize(QSize(150, 0))
        self.combobox_connectionstring.setMaximumSize(QSize(250, 16777215))
        palette2 = QPalette()
        palette2.setBrush(QPalette.Active, QPalette.WindowText, brush6)
        brush16 = QBrush(QColor(27, 29, 35, 255))
...
#endif
        self.combobox_connectionstring.setPalette(palette2)
        self.combobox_connectionstring.setStyleSheet(u"")

        self.horizontalLayout_10.addWidget(self.combobox_connectionstring)

        self.combobox_baudrate = QComboBox(self.frame_label_top_btns)
        ...
        self.combobox_baudrate.setMinimumSize(QSize(100, 0))
        self.combobox_baudrate.setMaximumSize(QSize(200, 16777215))
        self.combobox_baudrate.setStyleSheet(u"")

        self.horizontalLayout_10.addWidget(self.combobox_baudrate)
        ...
        self.btn_connect.setMinimumSize(QSize(60, 0))
        self.btn_connect.setMaximumSize(QSize(100, 35))
...
"}")
        ...
        self.frame_btns_right.raise_()
        self.frame_label_top_btns.raise_()
        ...
        self.frame_center.setStyleSheet(u"QFrame{background-color: rgb(40, 44, 52);}")
        ...
        sizePolicy2.setHeightForWidth(self.btn_home_page.sizePolicy().hasHeightForWidth())
        self.btn_home_page.setSizePolicy(sizePolicy2)
        font3 = QFont()
        font3.setPointSize(14)
        self.btn_home_page.setFont(font3)
...
"}")
        self.btn_home_page.setIconSize(QSize(32, 32))
        ...
        self.btn_indicators_page.setFont(font3)
        self.btn_indicators_page.setStyleSheet(u"QPushButton {	\n"
"	border: none;\n"
"	background-color: transparent;\n"
"}\n"
"QPushButton:hover {\n"
...
"	border-right: 6px solid rgb(85, 170, 255);\n"
"}")
        self.btn_indicators_page.setIconSize(QSize(32, 32))
        ...
        sizePolicy2.setHeightForWidth(self.btn_targets_page.sizePolicy().hasHeightForWidth())
        self.btn_targets_page.setSizePolicy(sizePolicy2)
        self.btn_targets_page.setFont(font3)
        self.btn_targets_page.setStyleSheet(u"QPushButton {	\n"
"	border: none;\n"
"	background-color: transparent;\n"
"}\n"
"QPushButton:hover {\n"
...
"}")
        ...
        self.frame_content_right.raise_()
...
#if QT_CONFIG(tooltip)
        self.combobox_baudrate.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Baud Rate</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.combobox_baudrate.setCurrentText(QCoreApplication.translate("MainWindow", u"128000", None))
#if QT_CONFIG(tooltip)
        self.btn_connect.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Connect</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.btn_home_page.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Home</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.btn_home_page.setText("")
#if QT_CONFIG(tooltip)
        self.btn_indicators_page.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>Indicators</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
